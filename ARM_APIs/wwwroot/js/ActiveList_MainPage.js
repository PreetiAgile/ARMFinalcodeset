...
class AxTasks {
    constructor() {
        ...
        this.processRowHtml = `
        <div class="d-flex align-items-center HP-ActiveList-Items" data-process="{{processname}}" data-type="{{tasktype}}"
    data-taskid="{{taskid}}" data-transid="{{transid}}" data-keyvalue="{{keyvalue}}">
        ...
        <li class="nav-item" role="presentation" title="{{processname}}" data-process="{{processname}}" onclick="axTasksObj.filterTasks('process','{{processname}}',this)">
            ...
            <span class="AC-List-Counts"></span>
        </li>`
        ...
        this.taskBtnsHtml.return = `
            <div class="task-actions-sets d-flex" id="ACT-Return">
