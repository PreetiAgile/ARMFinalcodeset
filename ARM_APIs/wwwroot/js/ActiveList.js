...
class AxTasks {
    constructor() {
        ...
        <div class="row">
            <div class="col-md-12 pb-8 task-listing-card" data-process="{{processname}}" data-type="{{tasktype}}" data-taskid="{{taskid}}">
                <h2 class="task-heading">
                    ...
                    <a href="javascript:void(0)" onclick="axTasksObj.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}')">
        ...
        this.taskListHtml = `
        <table class="table align-middle  fs-6 gy-5 mb-0 dataTable no-footer task-listing-card" data-process="{{processname}}" data-type="{{tasktype}}" data-taskid="{{taskid}}">
            <tbody>
                <tr class="d-flex ">
                    ...
                    <td class="d-flex align-items-center task-name">
                        <div class="d-flex flex-column">
                            ...
                            <input type="checkbox" value="" class="form-check-input task-list-checkbox">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold fs-6  mb-1 task-title"><span href="javascript:void(0)" onclick="axTasksObj.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}')"><span class="material-icons material-icons-style material-icons-1 display-icon task-listing-icons">{{displayicon}}</span>{{displaytitle}}</span></a>
                    ...
                    <td class="task-right">
                        ...
                        <div class="d-flex flex-row task-process">
                            ...
                            <a href="javascript:void(0)" title="Assigned By" class="text-gray-800 fs-6 mb-1 task-date">On: {{eventdatetime}}</a>
                        </div>
                    </td>
                ...
                <tr class="taskSubrow{{taskid}} d-none">
        ...
        this.taskBtnsHtml.make = `
            <a href="javascript:void(0)" title="Make" class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  btn-sm  me-2" onclick="axTasksObj.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}')""><span class="material-icons material-icons-style material-icons-2" style="color: orange;">assignment</span></a>`;
        ...
        <div class="task-actions-sets d-flex">
            <a href="javascript:void(0)" title="Return"
                class="btn btn-white btn-color-gray-700 btn-active-primary d-inline-flex align-items-center  me-2  btn-sm"
                onclick="axTasksObj.doReturn('{{taskid}}', this)"><span class="material-icons material-icons-style material-icons-2"
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bolder w-400px Active_list_popover"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm" onclick="return axTasksObj.doReturn('{{taskid}}', this)">Return</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bolder w-400px Active_list_popover"
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Approval-OK">
                            <button class="btn btn-sm btn-primary shadow-sm" onclick="return axTasksObj.doReturn('{{taskid}}', this)">Ok</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            <a href="javascript:void(0)" href="javascript:void(0)" title="Return" onclick="axTasksObj.doReturn('{{taskid}}', this);" class="mobile">
                ...
                <div class="card">
                    <div class="card-body py-5z">
                        ...
                        <div class="text-center Return-OK">
                            <button class="btn btn-sm btn-primary shadow-sm mobile"
                                onclick="return axTasksObj.doReturn('{{taskid}}', this);">Return</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <li>
            <a href="javascript:void(0)" title="Make" onclick="axTasksObj.openProcess('{{processname}}','{{keyfield}}','{{keyvalue}}')">
                <span class="material-icons material-icons-style material-icons-2">
        ...
        <li>
            <a href="javascript:void(0)" title="Check" onclick="axTasksObj.openHistory('{{processname}}','{{keyfield}}','{{keyvalue}}')"  style="color: blue;">
                <span class="material-icons material-icons-style material-icons-2">
    ...
    doReturn(taskId, elem) {
        let isValidComments = this.checkComments('RETURN', taskId, elem);
        if (!isValidComments)
            return;

        this.doTaskAction('RETURN', taskId, 'APPROVE', elem);
    }
    ...
    doTaskAction(action, taskId, taskType, elem) {
        ...
        let returnTo = "";
        if (action == "RETURN") {
            returnTo = document.querySelector(`select[name="returnto_${taskId}"]${isMobile}`)?.value || '';
        }
        let data = { action: action, taskId: taskId, taskType: taskType, statusReason: taskReason, statusText: taskText, returnTo: returnTo };
    ...
    showTasks() {
        ...
        if (this.dataSources["Tasks"]?.length == undefined || this.dataSources["Tasks"].length == 0) {
            if (this.isUndefined(parent.axProcessObj)) {
                ...
                document.querySelector(`#${this.view}_view`).innerHTML = "";
                document.querySelector(`#${this.view}_view`).insertAdjacentHTML("beforeend", ` ${this.taskProcessedCardHtml} `);
            }
        }
        else {
            document.querySelector(`#${this.view}_view`).innerHTML = "";
            this.dataSources["Tasks"].forEach((rowData, idx) => {
                switch (rowData.tasktype.toUpperCase()) {
                    case "MAKE":
                        ...
                        rowData.mobile_task_buttons_html = this.mobileTaskButtons.make;
                        break;
                    case "CHECK":
                        rowData.task_buttons_html = this.taskBtnsHtml.check;
                        rowData.mobile_task_buttons_html = this.mobileTaskButtons.check + this.mobileTaskButtons.return;

                        break;
                    case "APPROVE":
                        rowData.task_buttons_html = this.taskBtnsHtml.approve;
                        rowData.mobile_task_buttons_html = this.mobileTaskButtons.approve + this.mobileTaskButtons.reject + this.mobileTaskButtons.return;
                        break;
                }
