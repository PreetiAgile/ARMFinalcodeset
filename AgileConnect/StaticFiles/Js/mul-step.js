!(function (t, s, e, n) {
    ...
    t.extend(i.prototype, {
        ...
        _setToolbar: function () {
            ...
            var s = this.options.toolbarSettings.showNextButton !== !1 ? t("<button></button>").text(this.options.lang.next).addClass("btn btn-light ms-1 sw-btn-next").attr("type", "button") : null,
                e = this.options.toolbarSettings.showPreviousButton !== !1 ? t("<button></button>").text(this.options.lang.previous).addClass("btn btn-light sw-btn-prev").attr("type", "button") : null,
                n = t("<div></div>").addClass("btn-group mr-2 sw-btn-group add-colctrl").attr("role", "group").append(e, s),
                i = null;
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case "top":
                    ...
                    break;
                case "bottom":
                    (a = t("<div></div>").addClass("btn-toolbar sw-toolbar d-flex justify-content-center sw-toolbar-bottom justify-content-" + this.options.toolbarSettings.toolbarButtonPosition)),
                        a.append(n),
