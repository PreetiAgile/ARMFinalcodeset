...
!(function (t, e) {
    ...
    return function (t, e, s) {
        ...
        i(t, "text", "string", !0),
            i((s = s || {}), "options", "object"),
            i((e = e || 3e3), "timeout", "number"),
            (s.styles = s.styles || {}),
            i(s.styles, "styles", "object"),
            (s.align = s.align || "center"),
            i(s.align, "align", "string", !0, ["left", "center", "right"]),
            (s.valign = s.valign || "top"),
            i(s.valign, "valign", "string", !0, ["top", "bottom"]),
            (s.classList = s.classList || []),
            i(s.classList, "classList", "array");
        var n = ["toastmaker", "toast-header", "toastmaker-" + s.valign, "toastmaker-" + s.align];
        ...
        for (var r in (a.appendChild(o), (a.style.animationDuration = e / 2e9 + "s"), s.styles)) {
